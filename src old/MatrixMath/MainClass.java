...
class MainClass {
    ...
    public static void main(String[] args) {
        ...
        MatMathSeqImpl mSeq = new MatMathSeqImpl();  // sequential calculation
        MatMathForkJoinImpl mPool  = new MatMathForkJoinImpl(); //fork-join calculation
        MatMathStreamImpl mStream = new MatMathStreamImpl();
        MatMathThreadImpl mThread = new MatMathThreadImpl();
